...
import { ButtonContext, editorContext } from '../../context/Context'


const WaveEdit = (props) => {
    const {editableState, idValue} = useContext(ButtonContext)
    const { setPlayAudio } = useContext(editorContext)
    ...
    }, [minWidthMove, maxWidthMove, effectiveDuration, editableState, idValue, audioSegments, catchValueId, setRemovedSegmentIds])
    ...
    }, [props.audio, effectiveDuration, minWidthMove, maxWidthMove])
